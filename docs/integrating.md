# Integrating ILInsurance

## From Solidity

```solidity
import {ILInsuranceHook} from "il-insurance/src/hooks/ILInsuranceHook.sol";
...
const hook = getHook("il-insurance");
const address = hookAddress("il-insurance", 8453);              // Base
...
```solidity
IHookMetadata(hookAddress).hookName();   // "ILInsurance"
...
More at https://il-insurance.pages.dev.
